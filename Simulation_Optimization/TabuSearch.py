...
def tabu_search(initial_guess, budget, price_bed, price_caregiver, original_num_beds, original_num_caregivers,
    ...
    while True:
        ...
        best_results[current_minimizer[2]] = (original_num_beds + current_minimizer[0], original_num_caregivers + current_minimizer[1], current_minimizer[3], total_penalty)  # Update to the current point
