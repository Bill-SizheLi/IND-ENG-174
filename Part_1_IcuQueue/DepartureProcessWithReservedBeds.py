...
def simultaneously_return(delta_arrival = 0.00, delta_length_of_stays=0.00, capacity = capacity, reserved_capacity=reserved_capacity):
    ...
    departure_times, start_times = simulate_departure_process_with_reserved_beds(arrival_times, severity_level_list, length_of_stays, capacity, reserved_capacity)
